...
const I18N = {
  uz: {
    ...
    "mcp.chatgpt.title": "Masofaviy ulanish (Claude Desktop Connectors yoki ChatGPT)",
    "mcp.chatgpt.body": "Kompyuteringizda hech narsa o'rnatmasdan ulanishning yo'li: Claude Desktop'da Settings → Connectors → Add custom connector, yoki ChatGPT'da Settings → Connectors → Add custom connector bo'limiga quyidagi manzil va tokenni kiriting. Bu bitta yechim ikkalasiga ham ishlaydi, chunki ikkalasi ham bir xil masofaviy MCP protokolini gapiradi.",
  ...
  ru: {
    ...
    "mcp.chatgpt.title": "Удалённое подключение (Claude Desktop Connectors или ChatGPT)",
    "mcp.chatgpt.body": "Способ подключиться без установки чего-либо на компьютер: в Claude Desktop — Settings → Connectors → Add custom connector, в ChatGPT — тот же путь Settings → Connectors → Add custom connector. Введите адрес и токен ниже. Один и тот же адрес работает для обоих, так как оба говорят по одному и тому же удалённому протоколу MCP.",
  ...
  en: {
    ...
    "mcp.chatgpt.title": "Remote connection (Claude Desktop Connectors or ChatGPT)",
    "mcp.chatgpt.body": "The way to connect without installing anything on your computer: in Claude Desktop, go to Settings → Connectors → Add custom connector; in ChatGPT, the same path is Settings → Connectors → Add custom connector. Enter the address and token below. The same address works for both, since they both speak the same remote MCP protocol.",
