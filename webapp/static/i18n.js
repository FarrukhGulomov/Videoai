...
const I18N = {
  uz: {
    ...
    "step3.modelAdvanced": "Aniq modelni tanlash (ixtiyoriy)",
  ...
  ru: {
    ...
    "step3.modelAdvanced": "Выбрать конкретную модель (необязательно)",
  ...
  en: {
    ...
    "step3.modelAdvanced": "Choose the exact model (optional)",
    "tier.budget": "Budget",
