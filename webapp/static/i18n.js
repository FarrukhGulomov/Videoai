...
const I18N = {
  uz: {
    ...
    "mcp.chatgpt.notDeployed": "Bu serverda ChatGPT uchun masofaviy ulanish hali yoqilmagan. Administratordan so'rang yoki mcp/README.md faylidagi \"Streamable HTTP\" bo'limiga qarang.",
  ...
  ru: {
    ...
    "mcp.chatgpt.notDeployed": "Удалённое подключение для ChatGPT на этом сервере пока не включено. Обратитесь к администратору или смотрите раздел \"Streamable HTTP\" в mcp/README.md.",
  ...
  en: {
    ...
    "mcp.chatgpt.notDeployed": "Remote ChatGPT access isn't enabled on this server yet. Ask the admin, or see the \"Streamable HTTP\" section in mcp/README.md.",
